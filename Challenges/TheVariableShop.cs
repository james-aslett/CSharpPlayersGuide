...
//float digits of precision 7
float myFloat = 3.5623f;
//double digits of precision 15-16
double myDouble = 3.5623;
//decimal digits of precision 28-29
decimal myDecimal = 3.5623m;
//char only holds single character
char myChar = 'a';
